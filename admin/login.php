...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT Admin_ID FROM admin_account WHERE Admin_Username=:username and Admin_Password=:password";
    ...
    if($query->rowCount() > 0)
		{
			foreach ($results as $result) {
				$_SESSION['odmsaid']=$result->Admin_ID;
			}
	if(!empty($_POST["remember"])) {
		...
		// $sql ="INSERT INTO audit_trail (Activity, Modified_By, Username_or_Client_ID) VALUES ('Admin Login', 'Admin', :username)";
    	// $query=$dbh->prepare($sql);
		// $query-> bindParam(':username', $username, PDO::PARAM_STR);
		// $query-> execute();
	} 
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Shortcut Admin - Login Page</title>
