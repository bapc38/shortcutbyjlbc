...
$sql ="SELECT Admin_ID FROM admin_account WHERE Admin_ID=:adminid and Admin_Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update admin_account set Admin_Password=:newpassword where Admin_ID=:adminid";
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Shortcut Admin - Change Password</title>
