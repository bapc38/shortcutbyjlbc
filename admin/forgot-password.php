...
if(isset($_POST['submit']))
  {
	...
	$newpassword=md5($_POST['newpassword']);
  	$sql ="SELECT Admin_Email FROM admin_account WHERE Admin_Email =:email and Admin_Mobile =:mobile";
...
if($query -> rowCount() > 0)
{
	$con="update admin_account set Admin_Password=:newpassword where Admin_Email=:email and Admin_Mobile=:mobile";
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Shortcut Admin - Forgot Password Page</title>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">Hello, Admin!</span>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">Don’t worry, we’ve got your back</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Please enter details</h2>
                                </div>
                                ...
                                <form class="js-validation-signin px-30" method="post" name="chngpwd" onSubmit="return valid();">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="text" class="form-control"  name="mobile" required="true" maxlength="11" pattern="[0-9]+">
